...
function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function renderLabeledIcon(children) {
      ...
      var affixWrapperCls = classNames(props.className, "".concat(props.prefixCls, "-affix-wrapper"), (_classNames4 = {}, _defineProperty(_classNames4, "".concat(props.prefixCls, "-affix-wrapper-sm"), props.size === 'small'), _defineProperty(_classNames4, "".concat(props.prefixCls, "-affix-wrapper-lg"), props.size === 'large'), _classNames4));
      return React.createElement("span", {
