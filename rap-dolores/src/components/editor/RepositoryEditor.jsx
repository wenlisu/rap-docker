...
class RepositoryEditor extends Component {
  ...
  static childContextTypes = {
    ...
    onSortTypeList: PropTypes.func.isRequired,
      ...
      <article className='RepositoryEditor'>
        ...
        <div className='body'>
          ...
          <div className='InterfaceWrapper'>
            <TypeList types={mod.types} repository={repository} type={type} mod={mod}/>
            <InterfaceList itfs={type.interfaces} repository={repository} type={type} mod={mod} itf={itf} />
            <InterfaceEditor itf={itf} properties={properties} mod={mod} type={type} repository={repository} />
          </div>
        </div>
      </article>
    )
