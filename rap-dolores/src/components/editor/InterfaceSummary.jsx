...
import { PropTypes, Link, replace, StoreStateRouterLocationURI, Mock, _ } from '../../family'
...
class InterfaceSummary extends Component {
  ...
  initFetch = () => {
    ...
    this.scopedData.response = Mock.mock(
      Object.assign({}, _.pick(this.scopedData.request, extraKeys), scopedTemplate.response)
    )
    console.log('this.scopedData', this.scopedData);
  }

  render () {
    const { repository = {}, mod = {}, type = {}, itf = {}, editable } = this.props
    ...
    return (
      <div className='InterfaceSummary'>
        <div className='header'>
          ...
          <span className='hide'>
            <DialogController content={<InterfaceForm title='修改接口' repository={repository} mod={mod} type={type} itf={itf} />} onResolved={this.handleUpdate}>
