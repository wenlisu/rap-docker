...
class InterfaceEditor extends Component {
  ...
  render () {
    const { auth, repository, mod, type, itf } = this.props
    ...
    return (
      <article className='InterfaceEditor'>
        ...
        <InterfaceSummary repository={repository} mod={mod} itf={itf} type={type} active editable={editable} stateChangeHandler={this.summaryStateChange} /> 
        <RequestPropertyList
        ...
        <ResponsePropertyList properties={this.state.properties} editable={editable}
          repository={repository} mod={mod} type={type} itf={this.state.itf} />
        <RModal
