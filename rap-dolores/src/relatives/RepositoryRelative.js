          ...
          return {
            ...
            data: {
              ...
              modules: modules.map(mod => ({
                ...mod,
                types: mod.types.map(type => ({
                  ...type,
                  interfaces: type.interfaces.map(itf => {
          ...
          return {
            ...
            data: {
              ...
              modules: modules.map(mod => ({
                ...
                types: mod.types.map(type => ({
                  ...type,
                  interfaces: type.interfaces.map(x => {
          ...
          return {
            ...
            data: {
              ...
              modules: modules.map(mod => ({
                ...
                types: mod.types.map(type => ({
                  ...type,
                  interfaces: type.interfaces.filter(x => x.id !== itfId)
                }))
              }))
            }
          }
          ...
          return {
            ...
            data: {
              ...
              modules: modules.map(mod => mod.id === itf.moduleId ? ({
                ...mod,
                types: mod.types.map(type => type.id === itf.typeId ? ({
                  ...type,
                  interfaces: [...type.interfaces, itf]
                }) : type)
              }) : mod)
            }
          }
