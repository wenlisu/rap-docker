...
const types = ['String', 'Number', 'Boolean', 'Object', 'Array', 'Function', 'RegExp', 'Long', 'Integer']
...
export const  BO_JSON =  { id: USER_ID++, json: '{text:text}', creatorId: USER_ID }
...
export const BO_ORGANIZATION_COUNT = 1
...
export const BO_TYPE_COUNT = 2
export const BO_TYPE_FN = (source: any) => {
  return Object.assign(
    mock({
      id: TYPE_ID++,
      name: '类型@ctitle(4)',
