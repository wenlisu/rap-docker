...
CREATE TABLE `interfaces` (
  ...
  `typeId` bigint(11) unsigned DEFAULT NULL COMMENT '-',
  ...
  CONSTRAINT `interfaces_ibfk_1` FOREIGN KEY (`typeId`) REFERENCES `types` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `interfaces_ibfk_2` FOREIGN KEY (`moduleId`) REFERENCES `modules` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `interfaces_ibfk_3` FOREIGN KEY (`creatorId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `interfaces_ibfk_4` FOREIGN KEY (`lockerId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `interfaces_ibfk_5` FOREIGN KEY (`repositoryId`) REFERENCES `repositories` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) COMMENT='接口';
...
CREATE TABLE `loggers` (
  ...
  CONSTRAINT `loggers_ibfk_5` FOREIGN KEY (`typeId`) REFERENCES `types` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `loggers_ibfk_6` FOREIGN KEY (`interfaceId`) REFERENCES `interfaces` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) COMMENT='操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `properties` (
  ...
  CONSTRAINT `properties_ibfk_4` FOREIGN KEY (`typeId`) REFERENCES `types` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `properties_ibfk_5` FOREIGN KEY (`repositoryId`) REFERENCES `repositories` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) COMMENT='属性';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `json` (
  `id` bigint(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '唯一标识',
  `json` varchar(128) NOT NULL COMMENT '-',
  PRIMARY KEY (`id`),
) COMMENT='用户';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
