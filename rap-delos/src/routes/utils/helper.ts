import { Module, Type, Interface, Property } from '../../models'
...
const genExampleType = (extra: any) => Object.assign({
  name: '示例分类',
  creatorId: undefined,
  repositoryId: undefined,
  moduleId: undefined,
...
const initModule = async (mod: Module) => {
  let type = await Type.create(genExampleType({
